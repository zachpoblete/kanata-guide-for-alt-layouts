...
> [!IMPORTANT]
> These instructions are up to date with Kanata v1.10.1. The way Kanata formats its releases sometimes changes, so if there's a newer version, some of the steps below might be outdated. But I'll try my best to regularly update the instructions as new Kanata versions get released.
